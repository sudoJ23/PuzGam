...
var drawingApp = (function () {
	...
	var canvas,
		...
		init = function () {
			...
			crayonImage.src = "img/paint/crayon-outline.png";

			markerImage.onload = resourceLoaded;
			markerImage.src = "img/paint/marker-outline.png";

			eraserImage.onload = resourceLoaded;
			eraserImage.src = "img/paint/eraser-outline.png";

			crayonBackgroundImage.onload = resourceLoaded;
			crayonBackgroundImage.src = "img/paint/crayon-background.png";

			markerBackgroundImage.onload = resourceLoaded;
			markerBackgroundImage.src = "img/paint/marker-background.png";

			eraserBackgroundImage.onload = resourceLoaded;
			eraserBackgroundImage.src = "img/paint/eraser-background.png";

			crayonTextureImage.onload = resourceLoaded;
			crayonTextureImage.src = "img/paint/crayon-texture.png";

			outlineImage.onload = resourceLoaded;
			outlineImage.src = "img/paint/watermelon-duck-outline.png";
		};
